...
import CardComponent2 from '../components/list/CardComponent2';
import RankingList from '../components/list/RankinList';

function ComFundingPage2() {
  ...
  return (
    <div style={{ width: '75%', margin: '1rem auto' }}>
      ...
      {isListVisible && <RankingList rankings={rankings} isFunding={false}/>}
    </div>
  );
}

export default ComFundingPage2;
