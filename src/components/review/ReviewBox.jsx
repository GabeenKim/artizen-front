...
export default function ReviewBox({reviewInfo, reviews}){
    ...
    return(
        <BOX >
        {
            reviewInfo &&
            <InfoDIV>
            <h2>{reviewInfo.CONTENT_NAME}</h2>
            <span>
                <Rating value={reviewInfo.AVG_SCORE} precision={0.5} readOnly/>
                <p>{Math.round(reviewInfo.AVG_SCORE*10)/10}</p>
            </span>
            </InfoDIV>
        }    
